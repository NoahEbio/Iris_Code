...
2. Open **DEBUG**.
3. Tap **Start Camera** and approve camera permission.
4. Tap **Connect BLE** and select the Iris Arduino.
5. Tap **Enable Audio** and approve microphone permission.
6. Paste a Picovoice AccessKey in the Porcupine setup box.
7. Tap **Start “Hey Atlas”**.
8. Say: `Hey Atlas, follow me.`
